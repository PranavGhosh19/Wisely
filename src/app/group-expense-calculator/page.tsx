  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-1">
        ...
        <section className="py-24 bg-primary/5">
          <div className="container mx-auto px-4 max-w-4xl text-center">
            <h2 className="text-3xl md:text-5xl font-bold font-headline text-primary mb-8 leading-tight">
              The ultimate group expense tracker.
            </h2>
            <p className="text-lg text-muted-foreground mb-12 leading-relaxed">
              Don't settle for basic spreadsheets. Use the group expense calculator designed for modern collaboration. Secure, private, and mathematically perfect.
            </p>
            <Button asChild size="lg" className="h-14 px-12 rounded-2xl font-bold">
      ...
      <footer className="py-12 border-t text-center text-sm text-muted-foreground">
        <p>© 2024 Wisely Finance • Pro Group Expense Calculator.</p>
      </footer>
    </div>
  );
}
