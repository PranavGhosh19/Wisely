    ...
    <div className="flex min-h-screen flex-col md:flex-row bg-background">
      ...
      <main className="flex-1 p-4 md:p-8 pb-32 md:pb-8 max-w-7xl mx-auto w-full">
        <header className="mb-6">
          <Button 
            variant="ghost" 
            className="mb-2 -ml-2 text-muted-foreground hover:text-primary gap-2 h-8 px-2"
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                ...
                <Button 
                  variant="outline" 
                  size="icon" 
                  className="h-9 w-9 shrink-0 rounded-xl border-primary/20 bg-white hover:bg-primary/5 hover:text-primary transition-all active:scale-95 shadow-sm"
        ...
        <div className="grid gap-3 sm:gap-6 grid-cols-2 lg:grid-cols-3 mb-8">
          ...
          <Card className="border-none shadow-sm bg-white rounded-2xl">
            ...
            <CardContent className="p-4 sm:p-6 pt-0 sm:pt-0">
              ...
              <div className="flex items-center gap-1 mt-1 text-muted-foreground text-[10px] sm:text-[11px] font-bold uppercase">
      ...
      <Dialog open={isQrOpen} onOpenChange={setIsQrOpen}>
        <DialogContent className="w-[92%] max-w-sm rounded-[2rem] p-6 sm:p-10 border-none shadow-2xl overflow-hidden">
          <DialogHeader className="text-center space-y-2 mb-2">
            <DialogTitle className="text-2xl sm:text-3xl font-bold font-headline text-primary">Invite Members</DialogTitle>
          ...
          <div className="flex flex-col items-center gap-6 py-2">
            <div className="bg-white p-5 sm:p-8 rounded-[2rem] shadow-2xl shadow-primary/10 border-2 border-primary/5">
              <svg 
                viewBox="0 0 100 100" 
                className="w-40 h-40 sm:w-52 sm:h-52 text-primary"
                fill="currentColor"
              >
            ...
            <div className="w-full space-y-4">
              <div className="flex items-center gap-2 p-3 bg-muted/40 rounded-xl border border-border/50 group active:bg-muted/60 transition-colors">
                <span className="flex-1 text-[11px] sm:text-xs truncate text-muted-foreground font-mono">
                  {shareUrl}
                </span>
                <Button 
                  variant="ghost" 
                  size="icon" 
                  className="h-9 w-9 text-primary hover:bg-primary/10 shrink-0 rounded-lg"
              ...
              <Button 
                className="w-full rounded-2xl font-bold h-14 gap-2 text-base shadow-xl shadow-primary/20 bg-primary hover:bg-primary/90 transition-all active:scale-[0.98]"
                onClick={() => {
