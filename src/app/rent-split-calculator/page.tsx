  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
          ...
          <div className="grid gap-12 md:grid-cols-2">
            <div className="space-y-8">
              ...
              <div className="p-8 rounded-[2.5rem] bg-card border shadow-sm group hover:shadow-md transition-all">
                ...
                <h3 className="text-xl font-bold mb-3">Utility Integration</h3>
                <p className="text-muted-foreground text-sm">Go beyond rent. Use our rent split calculator to also divide Wi-Fi, electricity, and water bills in one go.</p>
              </div>
            </div>
      ...
      <footer className="py-12 border-t text-center text-sm text-muted-foreground">
        <p>© 2024 Wisely Finance • The Smartest Rent Split Calculator.</p>
      </footer>
    </div>
  );
}
